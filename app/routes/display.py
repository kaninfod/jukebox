...
@router.get("/api/display/brightness")
def get_brightness():
...
@router.post("/api/display/brightness")
...
@router.post("/api/display/brightness/increase")
...
@router.post("/api/display/brightness/decrease")
