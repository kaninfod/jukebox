...
(function() {
    ...
    function safeInit() {
        const statusArea = document.getElementById('nfc-status-area');
        if (statusArea) {
            // Component is loaded, but we need albumId from the caller
            // The caller (media-library.js) should call window.initNfcEncoding(albumId, albumName)
